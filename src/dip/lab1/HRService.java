...
public class HRService {
    ...
    /**
     * Constants can be used for retrieving annual wages of various employee
     * types. Is this the best way to go? Do we have type safety?
     */
    public static final String SALARIED_TYPE = "Salaried";
    public static final String HOURLY_TYPE = "Hourly";

    /**
     * Alternatively to the above, we could use an enum. Does this improve type
     * safety?
     */
     ...
     *
     * @param e - an employee object (not truly polymorphic!) employeeType - a
     * String identifying the employee type. A constant (see above) should be
     * used for this, but can you guarantee it will be? Are there other options?
     * Hint: enum
    ...
    /**
     * This is another truly horrible way to make decisions. Very rigid and
     * fragile!
     *
